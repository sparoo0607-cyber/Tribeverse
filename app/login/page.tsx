    ...
    <div className="min-h-screen bg-[#111418] flex items-center justify-center px-4 py-8">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-6">
          <a href="/" className="inline-flex items-baseline gap-2 mb-3">
          ...
          <h1 className="text-2xl font-black text-white uppercase tracking-tight" style={{fontFamily: 'Outfit,sans-serif'}}>
            ENTER TRIBEVERSE
          </h1>
        ...
        <div className="mb-6 p-4 rounded-2xl bg-[#FFE600]/10 border border-[#FFE600]/30 text-center">
          ...
          <a
            href="/register"
            className="inline-flex items-center gap-1 text-xs font-black text-white bg-[#FFE600] text-black px-4 py-2 rounded-xl mt-1 font-display uppercase tracking-widest hover:scale-105 transition-transform"
          >
        ...
        <div className="bg-white/[0.04] border border-white/10 rounded-3xl p-8 backdrop-blur-sm">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              style={{fontFamily: 'Outfit,sans-serif'}}
            >
              {loading ? 'Please wait…' : isSignUp ? 'Create Account' : tab === 'admin' ? 'Admin Login' : 'Sign In & View Pass'}
            </button>
          </form>
        ...
        <p className="text-center text-white/30 text-xs mt-6">
          <a href="/" className="hover:text-white transition-colors">← Back to Tribeverse Overview</a>
        </p>
      </div>
    </div>
  )
