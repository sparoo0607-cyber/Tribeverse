...
export default function TribeDetectivePage() {
 ...
 <span className="px-3 py-1 bg-[#00FFD1]/20 text-[#00FFD1] text-xs font-black rounded-full font-display uppercase tracking-widest">Stage 02</span>
 <span className="text-white/40 text-xs">Mystery Hunt</span>
 </div>
 <h1 className="text-3xl md:text-5xl font-black text-white font-display">Tribe Detective</h1>
 <p className="text-white/70 text-sm mt-1">Solve campus riddles, crack ciphers, and find the secret Tribe QR checkpoints.</p>
 </div>
